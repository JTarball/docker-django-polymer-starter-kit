...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issue.load_more_text'
        db.delete_column(u'content_issue', 'load_more_text')

        # Adding field 'Issue.author_pretty'
        db.add_column(u'content_issue', 'author_pretty',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'CommentCard.author_pretty'
        db.add_column(u'content_commentcard', 'author_pretty',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Update.load_more_text'
        db.delete_column(u'content_update', 'load_more_text')

        # Adding field 'Update.author_pretty'
        db.add_column(u'content_update', 'author_pretty',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Troubleshooting.load_more_text'
        db.delete_column(u'content_troubleshooting', 'load_more_text')

        # Adding field 'Troubleshooting.author_pretty'
        db.add_column(u'content_troubleshooting', 'author_pretty',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Comment.load_more_text'
        db.delete_column(u'content_comment', 'load_more_text')

        # Adding field 'Comment.author_pretty'
        db.add_column(u'content_comment', 'author_pretty',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Dependency.load_more_text'
        db.delete_column(u'content_dependency', 'load_more_text')

        # Adding field 'Dependency.author_pretty'
        db.add_column(u'content_dependency', 'author_pretty',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Issue.load_more_text'
        db.add_column(u'content_issue', 'load_more_text',
                      self.gf('django.db.models.fields.CharField')(default='See more Issues', max_length=50),
                      keep_default=False)

        # Deleting field 'Issue.author_pretty'
        db.delete_column(u'content_issue', 'author_pretty')

        # Deleting field 'CommentCard.author_pretty'
        db.delete_column(u'content_commentcard', 'author_pretty')

        # Adding field 'Update.load_more_text'
        db.add_column(u'content_update', 'load_more_text',
                      self.gf('django.db.models.fields.CharField')(default='See more of Changelog', max_length=50),
                      keep_default=False)

        # Deleting field 'Update.author_pretty'
        db.delete_column(u'content_update', 'author_pretty')

        # Adding field 'Troubleshooting.load_more_text'
        db.add_column(u'content_troubleshooting', 'load_more_text',
                      self.gf('django.db.models.fields.CharField')(default='See more from Troubleshooting', max_length=50),
                      keep_default=False)

        # Deleting field 'Troubleshooting.author_pretty'
        db.delete_column(u'content_troubleshooting', 'author_pretty')

        # Adding field 'Comment.load_more_text'
        db.add_column(u'content_comment', 'load_more_text',
                      self.gf('django.db.models.fields.CharField')(default='See more Comments', max_length=50),
                      keep_default=False)

        # Deleting field 'Comment.author_pretty'
        db.delete_column(u'content_comment', 'author_pretty')

        # Adding field 'Dependency.load_more_text'
        db.add_column(u'content_dependency', 'load_more_text',
                      self.gf('django.db.models.fields.CharField')(default='See more Dependencies', max_length=50),
                      keep_default=False)

        # Deleting field 'Dependency.author_pretty'
        db.delete_column(u'content_dependency', 'author_pretty')
