...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'content.comment': {
            ...
            'load_more_text': ('django.db.models.fields.CharField', [], {'default': "'See more Comments'", 'max_length': '50'}),
        ...
        u'content.dependency': {
            ...
            'is_reply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'length': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            'load_more_text': ('django.db.models.fields.CharField', [], {'default': "'See more Dependencies'", 'max_length': '50'}),
        ...
        u'content.issue': {
            ...
            'is_reply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'length': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            'load_more_text': ('django.db.models.fields.CharField', [], {'default': "'See more Issues'", 'max_length': '50'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Post']"}),
        ...
        u'content.troubleshooting': {
            ...
            'is_reply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'length': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            'load_more_text': ('django.db.models.fields.CharField', [], {'default': "'See more from Troubleshooting'", 'max_length': '50'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Post']"}),
        ...
        u'content.update': {
            ...
            'is_reply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'length': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            'load_more_text': ('django.db.models.fields.CharField', [], {'default': "'See more of Changelog'", 'max_length': '50'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Post']", 'null': 'True'}),
