#!/usr/bin/env python
"""
    accounts.registration.backend
    =============================

    Main backend object controlling activation and registration
    of users
...
class AccountsBackend(object):
    """
        ...
        You must have following settings:
          ...
          REGISTRATION_OPEN - if registration is open (note if registation is closed you can still activate if under ACCOUNT_ACTIVATION_DAYS time)
    """

    def activate(self, activation_key):
        """ Given an activation key try to activate user. Sends Signal if activated. """
        # TODO: if already activated
        #
