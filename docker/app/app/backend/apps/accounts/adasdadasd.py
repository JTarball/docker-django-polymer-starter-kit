...
class TestAccounts(APITestCase):
    ...
    def test_login_fail_no_users_in_db(self):
        """ Tests login should fail with 400 when no users in db. """
...
# test login when no users in db - shouldnt work
# test login with no input 
# test login validity - bruteforce - using one of the factories!!


# test logout when no users in db
